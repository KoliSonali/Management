...
$rs1=mysql_query("SELECT * from product where pno='".$rnooo."'");
$sno=1;
while( $row=mysql_fetch_array($rs1)) {
 echo "<tr bgcolor=black><td ><font size=4 color=white>Edit Product
Details</font></td></tr>";
...
size=30 maxlength=30 value='".$row[1]."'></td></tr>";
 echo "<tr><td>Publication</td><td><input type=text name=pubb
size=30 maxlength=30  value='".$row[2]."'></td></tr>";
echo "<tr><td>Availability</td><td><input type=text name=avail
